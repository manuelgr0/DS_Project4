...
\alignauthor \normalsize{Student One,  Student Two, Manuel Grossmann, Claude Haehni,  Pascal Oberholzer, Jakob Meier}\\
	\affaddr{\normalsize{ETH ID-1 XX-XXX-XXX, ETH ID-2 XX-XXX-XXX, 13-936-323, 13-929-773, 13-918-115, 13-925-573}}\\
	\email{\normalsize{one@student.ethz.ch, two@student.ethz.ch, manuelgr@student.ethz.ch, chaehni@student.ethz.ch, pascalo@student.ethz.ch, jakmeier@student.ethz.ch}}
}

%remove tabs at beginning of a paragraph
