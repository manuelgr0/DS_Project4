...
public class ChatManager implements Runnable {
    ...
    public ChatManager(Socket socket, Handler handler, byte[] msg, String mAddress) {
        type = 1;
        this.socket = socket;
        this.handler = handler;
        this.msg = msg;
        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    handler.obtainMessage(Connection.MESSAGE_READ,bytes, Integer.valueOf(mAddress), buffer).sendToTarget();
                } catch (IOException e) {
