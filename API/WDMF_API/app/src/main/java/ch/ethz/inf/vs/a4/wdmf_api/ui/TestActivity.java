...
public class TestActivity extends AppCompatActivity implements WifiP2pManager.ConnectionInfoListener/*, MessageTarget*/{
    ...
    void connect_device(WifiP2pDevice device) {
        ...
        mManager.connect(mChannel, config, new WifiP2pManager.ActionListener() {
            ...
            public void onFailure(int reason) {
                ...
                Toast.makeText(TestActivity.this, "Connection failed!", Toast.LENGTH_LONG).show();
            }
        });
    }
